...
def show_about():
    ...
    messagebox.showinfo("About ChangeToPNG", "ConvertToPNG Version 20240110.4\n"
                                              "Convert your WEBP images to PNG format easily.\n\n"
                                              "GitHub: https://github.com/diligencefrozen/ChangeToPNG")
    webbrowser.open("https://github.com/diligencefrozen/ChangeToPNG")

# Initialize the Tkinter window
root = tk.Tk()
root.title("ChangeToPNG")  # Set the window title

# Title icon settings: Automatically load the icon from the same directory as the script
script_dir = os.path.dirname(os.path.realpath(__file__))
icon_path = os.path.join(script_dir, "ChangeToPNG.ico")
